          ...
          <div class="clearfix">
            <div
              ...
              :class="[
                'col',
                'float-left',
                showTimeline && nowDay == dayIndex + 1
                  ? 'active'
                  : '',
              ]"
              :key="dayIndex"
            ...
            >
              <div
                ...
                @click="addNewList(part, partIndex)"
              ></div>
            </div>
          </div>
          <div>
            ...
            >
              <div class="course-content">
                ...
                <div class="actions clearfix">
                  ...
                  <div @click="editCourse(index)" class="action edit">
                    编辑
                  </div>
                </div>
              </div>
  ...
  created() {
    this.timer = setInterval(() => {
      ...
      this.nowTimelineTop =
        ...
        this.pixelOfMinutes
      this.nowTimeStr = `${this.formatTime(hours)}:${this.formatTime(
        minutes
      )}`
    }, 1000)
  },
