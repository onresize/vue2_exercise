...
const css5 = () => import('@/components/样式/css5.vue')
const css6 = () => import('@/components/样式/css6.vue')
...
const css11 = () => import('@/components/样式/css11.vue')
const css12 = () => import('@/components/样式/css12.vue')
const css13 = () => import('@/components/样式/css13.vue')
...
const Js_scroll = () => import('@/components/控制滚动条平滑滚动/index.vue')
    ...
    routes: [
        ...
        { path: '/myScreen', component: () => import('@/views/myScreen.vue') },
        {
            ...
            children: [
                ...
                { path: '/css5', component: css5 },
                { path: '/css6', component: css6 },
                { path: '/css7', component: css7 },
                { path: '/css8', component: css8 },
                { path: '/css9', component: css9 },
                { path: '/css10', component: css10 },
                { path: '/css11', component: css11 },
                { path: '/css12', component: css12 },
                { path: '/css13', component: css13 },
                ...
                { path: '/Js_scroll', component: Js_scroll },
                //为组件做缓存  
